...
void distortFrameByConstant(std::vector<point3D> &points, std::vector<imuState> &imu_states, double time_sweep_begin, Eigen::Matrix3d &R_imu_lidar, Eigen::Vector3d &t_imu_lidar)
{
    double time_sweep_end, time_point;

    time_sweep_end = imu_states.back().timestamp;
...
void distortFrameByImu(std::vector<point3D> &points, std::vector<imuState> &imu_states, double time_sweep_begin, Eigen::Matrix3d &R_imu_lidar, Eigen::Vector3d &t_imu_lidar)
{
